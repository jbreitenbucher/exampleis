...
%\documentclass[10pt,palatino,code,picins,kaukecopyright,openright,woolshort,dropcaps,verbatim,index,euler,twoside]{woosterthesis}
...
\bibliographystyle{plainnat} % you can use woosterchicago, mla-good, or apalike for humanities majors
