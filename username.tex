...
% for the report class with some additional options, blacklinks, palatino, abstractonly, and
% kaukecopyright. The kaukecopyright option will put the arch symbol with the word mark on the
...
% note that you can specify the woosterchicago option to use Chicago citation style and achemso to use the American Chamical Society citation format
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This is where the commands for the document begin. All \LaTeX{} documents must have a %\begin{document} text .... \end{document} structure.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\include{chapters/preface} % most theses do not have a preface so this should be commented
...
\include{appendices/java}
\include{appendices/cpp}
\include{appendices/afterword}
...
\bibliographystyle{woosterchicago}}{} % if you have used the woosterchicago class option then your references and citations will be in Chicago format
\ifthenelse{\boolean{achemso}}{
\bibliographystyle{achemso}}{} % if you have used the achemso class option then your references and citations will be in the American Chemical Society format
% if you do not specify a citation format then the default Wooster format will be used.
