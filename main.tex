...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Checked on 26/6/23 and compiles with no errors or warnings. Users must have the latest version of the TeXLive software and
...
%                                                                  Manual
%
% use this declaration to compile the manual (assuming you have not altered the original chapters and appendices)
...
%                                                                  Draft
%
% use this declaration for a draft  version of your IS (must only include your chapters and appendices and not any of the ones for the manual)
%\documentclass[code,palatino,picins,tikz,kaukecopyright,openright,oneside,euler,draft]{woosterthesis}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%                                                                  Print
%
% use this declaration for the print version of your IS (must only include your chapters and appendices and not any of the ones for the manual)
%\documentclass[12pt,code,palatino,picins,tikz,blacklinks,kaukecopyright,openright,oneside,euler,final]{woosterthesis} % probably what most students would use
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%                                                                  Electronic
%
% use this declaration for the PDF version of your IS (must only include your chapters and appendices and not any of the ones for the manual)
%\documentclass[12pt,code,palatino,picins,tikz,kaukecopyright,openright,oneside,euler,final]{woosterthesis}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\gradyear{2025}
\advisor{Advised by}{Your advisor (Department)}
\reader{Second reader}{Your second reader}
%\reader{Second advisor:}{Your second advisor (Department)}
\copyrighted   
%\copyrightdate{}                  
